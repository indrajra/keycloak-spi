 ...
 */
public class CustomIdpAuthenticatorFactory implements AuthenticatorFactory {

    public static final String PROVIDER_ID = "spi-idp-create-user-if-unique";
    static CustomIdpAuthenticator SINGLETON = new CustomIdpAuthenticator();
    ...
    public String getDisplayType() {
        return "SPI-Idp Create User If Unique";
    }
