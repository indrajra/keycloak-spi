package org.sunbird.keycloak.reset;
 ...
 * @version $Revision: 1 $
 */
public class ResetCredentials implements Authenticator, AuthenticatorFactory {

    private static final Logger logger = Logger.getLogger(ResetCredentials.class);

    public static final String PROVIDER_ID = "spi-reset-credential-email";
    ...
    public void authenticate(AuthenticationFlowContext context) {
        ...
        try {
            context.getSession()
                    .getProvider(EmailTemplateProvider.class, "spi-freemarker")
