 ...
 * @version $Revision: 1 $
 */
public class CustomRegistrationPassword implements FormAction, FormActionFactory {
    public static final String PROVIDER_ID = "spi-registration-password-action";
    ...
    public String getDisplayType() {
        return "SPI Password Validation";
    }

    @Override
    public String getReferenceCategory() {
        return "password"; //PasswordCredentialModel.TYPE;
    }
